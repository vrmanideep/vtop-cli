...
def check_for_updates():
    # We import these INSIDE the function so the updater is 100% self-contained
        ...
        if remote_version != CURRENT_VERSION:
            ...
            if choice == 'y':
                ...
                try:
                    ...
                    # Extended timeout for larger zip files
                    ...
                    with zipfile.ZipFile(io.BytesIO(zip_data)) as z:
                        for file_info in z.infolist():
                            ...
                            # Skip the root folder name generated by GitHub
